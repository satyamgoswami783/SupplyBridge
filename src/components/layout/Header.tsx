    ...
    <header className="sticky top-0 z-20 bg-white/90 backdrop-blur-md border-b border-slate-200 h-14 flex items-center px-4 gap-4">
      ...
      <div className="flex items-center gap-1 ml-auto">
        ...
        <div className="relative ml-1">
          ...
          {showProfileMenu && (
            <div className="absolute right-0 top-11 w-60 card shadow-card-lg z-50 p-2 overflow-hidden border border-slate-200">
              {/* User info preview header */}
              <div
                onClick={() => { setShowProfileMenu(false); openCurrentUserProfile(); }}
                className="p-3 bg-slate-50 rounded-xl mb-1.5 cursor-pointer hover:bg-slate-100 transition-colors flex items-center gap-3 border border-slate-100"
              >
