                ...
                <div className="flex items-start gap-3 w-full flex-1 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
                      <div>
                        <p className="font-semibold text-slate-800 break-words">{item.productName}</p>
                ...
                <div className="flex flex-wrap gap-2 w-full sm:w-auto justify-start items-center pt-3 sm:pt-0 pl-7 sm:pl-0 border-t sm:border-t-0 border-slate-100 dark:border-slate-800/60" onClick={e => e.stopPropagation()}>
                  ...
                  {role !== 'operations_staff' && (
                    <>
                      <button
                        ...
                        className="btn-success btn-sm flex items-center gap-1 text-xs py-1.5 px-3"
                      ...
                      <button
                        ...
                        className="btn-danger btn-sm flex items-center gap-1 text-xs py-1.5 px-3"
                  ...
                  {role === 'operations_staff' && (
                    <button
                      ...
                      className="btn-secondary btn-sm flex items-center gap-1 text-amber-700 border-amber-300 hover:bg-amber-50 text-xs py-1.5 px-3"
                    >
                      <PhoneForwarded size={13} /> Escalate
                    </button>
                  )}
                  <button onClick={() => handleOpenReview(item)} className="btn-secondary btn-sm flex items-center gap-1 text-xs py-1.5 px-3">
                    <Eye size={13} /> View
                  </button>
                </div>
              </div>
