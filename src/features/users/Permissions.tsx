...
const PERMISSION_MATRIX: Record<string, Record<string, boolean>> = {
  ...
  'Integrations':     { 'Super Admin': true,  'Admin': false, 'Catalog Manager': false, 'Integration Manager': true,  'Operations Staff': false },
  ...
  'Monitoring':       { 'Super Admin': true,  'Admin': false, 'Catalog Manager': false, 'Integration Manager': false, 'Operations Staff': true },
  'Reports':          { 'Super Admin': true,  'Admin': true,  'Catalog Manager': false, 'Integration Manager': false, 'Operations Staff': true },
  'Users':            { 'Super Admin': true,  'Admin': false, 'Catalog Manager': false, 'Integration Manager': false, 'Operations Staff': false },
  'Roles':            { 'Super Admin': true,  'Admin': false, 'Catalog Manager': false, 'Integration Manager': false, 'Operations Staff': false },
