    ...
    <div className="relative space-y-6">
      ...
      >
        {[
          ...
          { label: 'Total Catalog SKUs',  value: formatNumber(m.totalProducts), icon: <Package size={18} className="text-primary-600" />, iconBg: 'bg-primary-50', change: '+1.2K today', changeType: 'positive' as const },
          ...
          <motion.div key={i} variants={stagger.child} transition={{ duration: 0.25 }}>
            <StatsCard {...item} />
          </motion.div>
        ))}
      </motion.div>
