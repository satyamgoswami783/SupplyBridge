      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="card p-5">
          <p className="text-sm font-semibold text-slate-700 mb-4 flex items-center gap-2">
            <RefreshCw size={15} className="text-primary-600" /> Synchronization Status
          </p>
        ...
        <div className="card p-5">
          <p className="text-sm font-semibold text-slate-700 mb-4 flex items-center gap-2">
            <Briefcase size={15} className="text-primary-600" /> Job Summary
          </p>
          <div className="grid grid-cols-2 gap-3">
            {[
              { label: 'Running',   value: m.runningJobs,   color: 'text-cyan-600',    bg: 'bg-cyan-50',    icon: <PlayCircle size={18} /> },
              { label: 'Queued',    value: m.queuedJobs,    color: 'text-amber-600',   bg: 'bg-amber-50',   icon: <Clock size={18} /> },
        ...
        <div className="card p-5">
          <p className="text-sm font-semibold text-slate-700 mb-4 flex items-center gap-2">
            <Server size={15} className="text-primary-600" /> System Status
          </p>
          <div className="space-y-3">
            ...
            <div className="pt-2 border-t border-slate-100">
              <div className="flex justify-between mb-1.5">
                ...
                <span className="text-xs font-bold text-emerald-600">{m.systemHealth}%</span>
              </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
        ...
        <div className="xl:col-span-2 card p-5">
          <div className="flex items-center justify-between mb-4">
            <div>
              <p className="text-sm font-semibold text-slate-800">Synchronization Activity</p>
        ...
        <div className="card p-5">
          <div className="mb-4">
            <p className="text-sm font-semibold text-slate-800">Products by Supplier</p>
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <div className="flex items-center gap-4">
              <div className="text-3xl font-bold text-slate-900">{m.queueSize}</div>
            ...
            <div className="grid grid-cols-4 gap-2">
              {[
                ...
                <div key={i} className={`rounded-xl p-2 text-center ${s.ok ? 'bg-emerald-50' : 'bg-rose-50'}`}>
                  ...
                  <p className="text-2xs font-medium text-slate-600 leading-tight">{s.label}</p>
                </div>
              ))}
            </div>
          </div>
