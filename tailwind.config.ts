  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'card-md':    '0 12px 28px -4px rgba(79, 70, 229, 0.12), 0 4px 12px -2px rgba(15, 23, 42, 0.06)',
        'card-lg':    '0 24px 48px -12px rgba(79, 70, 229, 0.18), 0 8px 24px -4px rgba(15, 23, 42, 0.08)',
